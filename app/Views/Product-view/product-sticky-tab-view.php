...
<!-- Mirrored from portotheme.com/html/porto/demo-6/product-sticky-tab.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:54:03 GMT -->
<head>
    <meta charset="UTF-8">
                                ...
                                <div class="col-lg-7 col-md-6 product-single-gallery">
                                    <div class="product-slider-container product-item">
                                        <div class="product-single-carousel owl-carousel owl-theme">
                                            <div class="product-item">
                                                <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-1.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-1-big.jpg"/>
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-2.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-2-big.jpg"/>
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-3.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-3-big.jpg"/>
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-4.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-4-big.jpg"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="prod-thumbnail row owl-dots" id='carousel-custom-dots'>
                                        <div class="col-3 owl-dot">
                                            <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-1.jpg"/>
                                        </div>
                                        <div class="col-3 owl-dot">
                                            <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-2.jpg"/>
                                        </div>
                                        <div class="col-3 owl-dot">
                                            <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-3.jpg"/>
                                        </div>
                                        <div class="col-3 owl-dot">
                                            <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-4.jpg"/>
                                        </div>
                                    </div>
                                </div><!-- End .col-lg-7 -->
                        ...
                        <div class="product-single-tabs scrolling-box">
                            ...
                            <div class="tab-pane" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                                <div class="product-size-content">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="<?= base_url(); ?>/public/assets/images/products/single/body-shape.png" alt="body shape">
                                        </div><!-- End .col-md-4 -->
                    ...
                    <aside class="sidebar-product col-lg-3 padding-left-lg mobile-sidebar">
                        <div class="sidebar-wrapper">
                            <div class="widget widget-brand">
                                <a href="#">
                                    <img src="<?= base_url(); ?>/public/assets/images/product-brand.png" alt="brand name">
                                </a>
                            </div><!-- End .widget -->
                            ...
                            <div class="widget widget-banner">
                                <div class="banner banner-image">
                                    <a href="#">
                                        <img src="<?= base_url(); ?>/public/assets/images/banners/banner-sidebar.jpg" alt="Banner Desc">
                                    </a>
                                </div><!-- End .banner -->
                            </div><!-- End .widget -->
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="../../../../www.portotheme.com/html/porto/demo-6/<?= base_url(); ?>/public/assets/images/products/small/product-2.html" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="../../../../www.portotheme.com/html/porto/demo-6/<?= base_url(); ?>/public/assets/images/products/small/product-3.html" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                        ...
                                        <div class="featured-col">
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="../../../../www.portotheme.com/html/porto/demo-6/<?= base_url(); ?>/public/assets/images/products/small/product-4.html" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="../../../../www.portotheme.com/html/porto/demo-6/<?= base_url(); ?>/public/assets/images/products/small/product-5.html" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="../../../../www.portotheme.com/html/porto/demo-6/<?= base_url(); ?>/public/assets/images/products/small/product-6.html" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
...
<!-- Mirrored from portotheme.com/html/porto/demo-6/product-sticky-tab.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:54:04 GMT -->
</html>