...
<!-- Mirrored from portotheme.com/html/porto/demo-6/product-extended-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:54:04 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
                ...
                <div class="container">
                    <div class="product-single-gallery product-item">
                        <div class="product-single-carousel owl-carousel owl-nav-simple">
                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-1.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-1-big.jpg" alt="product"/>
                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-2.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-2-big.jpg" alt="product"/>
                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-3.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-3-big.jpg" alt="product"/>
                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-4.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-4-big.jpg" alt="product"/>
            ...
            <div class="product-single-row">
                <div class="single-row-entire" style="background-image: url('<?= base_url(); ?>/public/assets/images/products/single/extended/bg-1.jpg');"></div>
                <div class="container">
            ...
            <div class="product-single-row" >
                <div class="single-row-bg" style="background-image: url('<?= base_url(); ?>/public/assets/images/products/single/extended/bg-2.jpg');"></div><!-- End .single-row-bg -->
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-xl-5">
            ...
            <div class="product-single-row single-row-reverse" >
                <div class="single-row-bg" style="background-image: url('<?= base_url(); ?>/public/assets/images/products/single/extended/bg-3.jpg');"></div><!-- End .single-row-bg -->
                <div class="container">
                    <div class="row">
            ...
            <div class="product-single-video" style="background-image: url('<?= base_url(); ?>/public/assets/images/products/single/extended/bg-4.jpg');">
                <div class="container">
                    <h3>Concept Film</h3>
                    <a href="https://www.youtube.com/watch?v=Ph_VkTVmXh4" class="video-btn">
                        Watch <img src="<?= base_url(); ?>/public/assets/images/products/single/extended/icon-play.png" alt="play">
                    </a>
                </div><!-- End .container -->
...
<!-- Mirrored from portotheme.com/html/porto/demo-6/product-extended-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:54:07 GMT -->
</html>