...
<!-- Mirrored from portotheme.com/html/porto/demo-6/product-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:54:57 GMT -->
<head>
    <meta charset="UTF-8">
                                ...
                                <div class="product-slider-container product-item">
                                    <div class="product-single-carousel owl-carousel owl-theme">
                                        <div class="product-item">
                                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-1-big.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-1-big.jpg"/>
                                        </div>
                                        <div class="product-item">
                                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-2-big.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-2-big.jpg"/>
                                        </div>
                                        <div class="product-item">
                                            <img class="product-single-image" src="<?= base_url(); ?>/public/assets/images/products/zoom/product-3-big.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-3-big.jpg"/>
                                        </div>
                                    </div>
