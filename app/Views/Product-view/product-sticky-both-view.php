...
<!-- Mirrored from portotheme.com/html/porto/demo-6/product-sticky-both.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:54:07 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <main class="main">
            ...
            <div class="container">
                <div class="product-single-container product-both-info">
                    ...
                    <div class="row">
                        <div class="product-single-details col-lg-3">
                        ...
                        <div class="col-lg-6 product-single-gallery product-list">
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-1.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-1-big.jpg" alt="product name">
                            ...
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-2.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-2-big.jpg" alt="product name">
                                    <span class="prod-full-screen">
                                        <i class="icon-plus"></i>
                                    </span>
                                </div>
                            ...
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-3.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-3-big.jpg" alt="product name">
                                    <span class="prod-full-screen">
                                        <i class="icon-plus"></i>
                                    </span>
                                </div>
                            ...
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?= base_url(); ?>/public/assets/images/products/zoom/product-4.jpg" data-zoom-image="<?= base_url(); ?>/public/assets/images/products/zoom/product-4-big.jpg" alt="product name">
                                    <span class="prod-full-screen">
                                        <i class="icon-plus"></i>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-3 product-single-details">
                            <div class="product-single-details sidebar-wrapper">
                                <div class="product-filters-container mb-1">
                                    ...
                                    <div class="product-single-qty product-single-filter">
                                ...
                                <div class="product-action">
                                    <a href="cart.html" class="paction add-cart ml-0" title="Add to Cart">
