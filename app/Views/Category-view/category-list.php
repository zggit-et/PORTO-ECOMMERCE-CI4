...
<!-- Mirrored from portotheme.com/html/porto/demo-6/category-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:55:05 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="container">
                                ...
                                <div class="dropdownmenu-wrapper">
                                    <ul class="compare-products">
                                        <li class="product">
                                            ...
                                            <h4 class="product-title"><a href="<?= base_url(); ?>/public/product.html">Lady White Top</a></h4>
                                        </li>
                                        <li class="product">
                                            <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            <h4 class="product-title"><a href="<?= base_url(); ?>/public/product.html">Blue Women Shirt</a></h4>
                                        </li>
                                    </ul>
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-dropdown dropdown-expanded">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li><a href="<?= base_url(); ?>/public/my-account.html">MY ACCOUNT </a></li>
                                    <li><a href="#">DAILY DEAL</a></li>
                                    <li><a href="#">MY WISHLIST </a></li>
                                    <li><a href="<?= base_url(); ?>/public/blog.html">BLOG</a></li>
                                    <li><a href="<?= base_url(); ?>/public/contact.html">Contact</a></li>
                        ...
                        <div class="product product-list-wrapper">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-desc">
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. <a href="https://www.portotheme.com/html/porto/demo-6/prorduct.html">Learn More</a></p>
...
<!-- Mirrored from portotheme.com/html/porto/demo-6/category-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Feb 2019 14:55:08 GMT -->
</html>